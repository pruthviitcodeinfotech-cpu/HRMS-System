  ...
  const navItems = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/payroll/process-payroll", label: "Process Payroll", isNew: false, permission: { feature: "payroll_processing", action: "read" } },
    ...
    },
    {
      ...
      items: [
        { href: "/settlements/loan-advance", label: "Loan & Advance", isNew: false, permission: { feature: "loan_advance", action: "read" } },
        { href: "/settlements/arrears", label: "Arrears", isNew: false, permission: { feature: "arrears", action: "read" } },
      ],
    },
    {
      href: "/reports",
