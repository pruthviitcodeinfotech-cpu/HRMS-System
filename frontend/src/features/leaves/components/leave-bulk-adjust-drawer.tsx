...
export function LeaveBulkAdjustDrawer({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (balanceCount === "" || isNaN(Number(balanceCount))) {
      toast.error("Please enter a valid leave balance count.");
      return;
    }
    if (!remarks.trim()) {
          ...
          >
            ...
            <div>
              ...
              <Input
                ...
                className="h-9 text-xs bg-white dark:bg-slate-950 border-slate-300 dark:border-slate-700 placeholder:text-slate-400"
              />
            </div>
